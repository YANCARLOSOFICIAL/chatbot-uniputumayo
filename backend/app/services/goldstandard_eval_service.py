...
_JUDGE_PROMPT = (
    ...
    "- Derivar el título profesional de una persona a partir del nombre de un programa "
    "que sí aparece en el contexto (ej. 'Ingeniero Forestal' a partir de 'Ingeniería "
    "Forestal', 'Administrador de Empresas' a partir de 'Administración de Empresas'). "
    "Es la misma palabra en su forma profesional, no un dato distinto.\n"
    "- Mencionar el nombre de la institución ('Uniputumayo', 'Institución Universitaria "
    "del Putumayo') o de un programa que el contexto ya confirma que existe, aunque esa "
    "mención exacta no esté en el fragmento citado.\n"
    "- Cualquier afirmación que la propia RESPUESTA ya matiza o aclara correctamente (ej. "
    "si aclara que algo es un ciclo previo/propedéutico de otro programa, no la marques "
    "por ese mismo dato). Relee la RESPUESTA completa antes de decidir — no juzgues una "
    "frase aislada fuera de su propio contexto dentro de la respuesta.\n\n"
    "SÍ es alucinación:\n"
