...
from app.routers import health, chat, rag, llm, documents, config, auth, audio, analytics, taxonomy, rag_eval
...
app.include_router(rag_eval.router, prefix="/api/v1/rag-eval", tags=["rag-eval"])
